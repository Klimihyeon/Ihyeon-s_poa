<%@page import="board.test.common.vo.PagingVO"%>
<%@page import="board.test.board.vo.CommBoardVO"%>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4">
			<img class = "col-md-12" src="/BT/img/banner.png">
			<p class="card-text">BGM 브레이브걸스 - rollin(1시간)</p>
			<audio autoplay controls> <source src="<%=request.getContextPath() %>/audio/lollin.mp4" type="audio/mp4"></audio>
			<!-- Categories Widget -->
			<div class="card my-4">
